...
## Oops -- got a little ahead to Ch 9
...
#            self.live_server_url = 'http://' + staging_server
    ...
    def test_layout_and_styling(self):
        ...
        #hbtest self.assertEqual(inputbox.size['width'], 24)
        self.assertAlmostEqual(
            inputbox.location['x'] + inputbox.size['width'] / 2,
            512,
            delta=20 # 10 was too small
        )
    ...
    def test_can_start_a_list_for_one_user(self):
        # Edith has heard about a to-do app.
...
#        )
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## We ue a new browser session to make sure that no information
        ...
        # He is less interesting than Edity...
        inputbox = self.browser.find_element('id', 'id_new_item')
